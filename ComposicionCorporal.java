...
public class ComposicionCorporal {
    ...
    public ComposicionCorporal() {
        ...
        this.persona = new Persona("00000", "NN", 2025, 01, 01, 'F', "a@gmail.com");
    ...
    public String clasificarGrasaCorporal() {
        ...
        if (sexo == 'F') {
            if (edad >= 18 && edad <= 39) {
                if (grasaCorporal < 17) return "Demasiado bajo";
                else if (grasaCorporal <= 30) return "Saludable";
                else if (grasaCorporal <= 36) return "Sobrepeso";
                return "Obesidad";
            } else if (edad >= 40 && edad <= 59) {
                if (grasaCorporal < 22) return "Demasiado bajo";
                else if (grasaCorporal <= 33) return "Saludable";
                else if (grasaCorporal <= 40) return "Sobrepeso";
                return "Obesidad";
            } else if (edad >= 60) {
                if (grasaCorporal < 23) return "Demasiado bajo";
                else if (grasaCorporal <= 35) return "Saludable";
                else if (grasaCorporal <= 41) return "Sobrepeso";
                return "Obesidad";
            }
        } else if (sexo == 'M') {
            if (edad >= 18 && edad <= 39) {
                if (grasaCorporal < 8) return "Demasiado bajo";
                else if (grasaCorporal <= 19) return "Saludable";
                else if (grasaCorporal <= 23) return "Sobrepeso";
                return "Obesidad";
            } else if (edad >= 40 && edad <= 59) {
                if (grasaCorporal < 10) return "Demasiado bajo";
                else if (grasaCorporal <= 21) return "Saludable";
                else if (grasaCorporal <= 27) return "Sobrepeso";
                return "Obesidad";
            } else if (edad >= 60) {
                if (grasaCorporal < 12) return "Demasiado bajo";
                else if (grasaCorporal <= 23) return "Saludable";
                else if (grasaCorporal <= 29) return "Sobrepeso";
                return "Obesidad";
            }
        }
        return "Clasificación no disponible";
    ...
    public void setMasaOsea(double masaOsea) {
        ...
        char sexo = persona.getSexo();
        if ((sexo == 'F' && (masaOsea < 2 || masaOsea > 3)) || (sexo == 'M' && (masaOsea < 3 || masaOsea > 5))) {
            throw new IllegalArgumentException("La masa ósea está fuera del rango permitido para el sexo indicado.");
        }
