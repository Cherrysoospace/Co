...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Service<InstalacionDeportiva> multipropositoService = new InstalacionDeportivaService(CanchaMultiproposito.class);

        Service<Alquiler> alquileresService = new AlquilerService(socioService, InstalacionDeportivaService.collectAll());
